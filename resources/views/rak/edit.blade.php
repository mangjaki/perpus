...
<div class="d-flex justify-content-center align-items-center">
    <div class="card col-lg-6">
      <div class="card-body">
        <h4 class="card-title d-flex justify-content-center align-items-center mdi mdi-book-open-page-variant "> Form Edit Rak <s class=" mdi mdi-book-open-page-variant"></s> </h4>
        <p class="card-description d-flex justify-content-center align-items-center">
          > Masukan Data Rak <
        </p>
        <form method="POST" action="{{ route('rak.update', $rakbuku['id']) }}" class="forms-sample">
          @method('PUT')
          @csrf
          <div class="form-group">
            <label for="kode_rak">Kode Buku</label>
            <input type="text" class="form-control" id="kode_rak" name="kode_rak" value="{{old('kode_rak') ? old('kode_rak'): $rakbuku['kode_rak'] }}" placeholder="Masukan Kode Rak">
            @error('kode_rak')
