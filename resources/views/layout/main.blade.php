      ...
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
          <a class="navbar-brand brand-logo" href="/">
            <img src="{{ url('images/logokuh.jpeg') }}" alt="logo" />
          </a>
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            ...
            <h3 class="welcome-sub-text">di Perpustakaan TXP</h3>
          </li>
        </ul>
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                ...
                <p class="fw-light text-muted mb-0">{{ auth()->user()->roleName }}</p>
              </div>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item nav-category">Categori Perpustakaan</li>
          <li class="nav-item">
      ...
      <div class="main-panel">
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">My Insta <a href="https://www.instagram.com/mhammdzacky_?igsh=MTB0dXN5OGJkNDlsbg==" target="_blank">Admin Web</a> from Multi data Palembang</span>
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Copyright © 2024. ZACKY AND RIFALDI</span>
          </div>
        </footer>
        <!-- partial -->
      </div>
